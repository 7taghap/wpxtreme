...
class UM_API {
	...
	***/
	function init(){
		...
		//globe api
		require_once um_path . 'core/um-globelabs.php';
		require_once um_path . 'core/um-globe-api.php';
		require_once um_path . 'core/um-globe-sms.php';
		require_once um_path . 'core/um-globe-auth.php';
		require_once um_path . 'core/um-globe-payment.php';
		...
		$this->globelabs = new UM_GlobeLabs();
		$this->globeapi = new GlobeApi();
