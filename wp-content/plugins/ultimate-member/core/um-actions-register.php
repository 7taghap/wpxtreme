<?php
	...
	***/
	...
	function um_add_user_frontend($args){
		...
		//register the user_id to session
	...
	***/
	...
	function um_post_registration_save($user_id, $args){
		...
		$args['is_signup'] = 1;
		//TODO change the url to globelabs
		
		exit(wp_redirect($ultimatemember->globelabs->getRegistrationUrl()));
// 		do_action('um_user_edit_profile', $args); //um-actioin-profile.
